...
stickiness, rewrite_worlds_from_rvs_fn) {
 ...
 //  var w = {
	...
	var inspect_nested = function(utterance, cf_premise_type, cf_conclusion_type, set_actual, actual_world) {
	  return Infer({method: "enumerate", maxExecutions: 100000000}, function() {
	    var w = prior_sampler();
	    var actual_world = set_actual ? actual_world : rewrite_worlds_from_rvs_fn(w);
