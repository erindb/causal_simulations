...
var setup_animation_for_world = function(result_index) {
  ...
  var display = results[result_index].display;
  if (display) {
    $("body").append(
    ...
    function init(){
      ...
      objects_storage["renderer" + result_index] =  PIXI.autoDetectRenderer(500, 300),
      ...
      objects_storage["drawn_ball_A_" + result_index].drawCircle(0, 0, objects_storage["ballABody" + result_index].shapes[0].radius); // x, y, radius
      // graphics.drawRect(-boxShape.width/2, -boxShape.height/2, boxShape.width, boxShape.height);

      // Add the ball to our container
      ...
      objects_storage["drawn_ball_B_" + result_index].drawCircle(0, 0, objects_storage["ballBBody" + result_index].shapes[0].radius); // x, y, radius
      objects_storage["container" + result_index].addChild(objects_storage["drawn_ball_B_" + result_index]);

      // if ball E exists
      if (objects_storage["ballEBody" + result_index]) {
        objects_storage["drawn_ball_E_" + result_index] = new PIXI.Graphics();
        objects_storage["drawn_ball_E_" + result_index].beginFill(0x009900);
        objects_storage["drawn_ball_E_" + result_index].drawCircle(0, 0, objects_storage["ballEBody" + result_index].shapes[0].radius); // x, y, radius
        objects_storage["container" + result_index].addChild(objects_storage["drawn_ball_E_" + result_index]);
      }


      objects_storage["drawn_floor_" + result_index] = new PIXI.Graphics();
      objects_storage["drawn_floor_" + result_index].beginFill(0x333333);
      objects_storage["drawn_floor_" + result_index].drawRect(0, 0, 100, 0.1); // x, y, radius
      objects_storage["container" + result_index].addChild(objects_storage["drawn_floor_" + result_index]);

      objects_storage["drawn_ceiling_" + result_index] = new PIXI.Graphics();
      objects_storage["drawn_ceiling_" + result_index].beginFill(0x333333);
      objects_storage["drawn_ceiling_" + result_index].drawRect(0, 0, 100, 0.1); // x, y, radius
      objects_storage["container" + result_index].addChild(objects_storage["drawn_ceiling_" + result_index]);



      objects_storage["drawn_block_A_" + result_index] = new PIXI.Graphics();
      objects_storage["drawn_block_A_" + result_index].beginFill(0x333333);
      objects_storage["drawn_block_A_" + result_index].drawRect(
        0,
        0,
        objects_storage["block_ABody" + result_index].shapes[0].width,
        objects_storage["block_ABody" + result_index].shapes[0].height);
      objects_storage["container" + result_index].addChild(objects_storage["drawn_block_A_" + result_index]);

      objects_storage["drawn_block_B_" + result_index] = new PIXI.Graphics();
      objects_storage["drawn_block_B_" + result_index].beginFill(0x333333);
      objects_storage["drawn_block_B_" + result_index].drawRect(
        0,
        0,
        objects_storage["block_BBody" + result_index].shapes[0].width,
        objects_storage["block_BBody" + result_index].shapes[0].height);
      objects_storage["container" + result_index].addChild(objects_storage["drawn_block_B_" + result_index]);



      objects_storage["drawn_lower_" + result_index] = new PIXI.Graphics();
      objects_storage["drawn_lower_" + result_index].beginFill(0x333333);
      objects_storage["drawn_lower_" + result_index].drawRect(
        0,
        0,
        objects_storage["lower" + result_index].shapes[0].width,
        objects_storage["lower" + result_index].shapes[0].height);
      objects_storage["container" + result_index].addChild(objects_storage["drawn_lower_" + result_index]);

      objects_storage["drawn_upper_" + result_index] = new PIXI.Graphics();
      objects_storage["drawn_upper_" + result_index].beginFill(0x333333);
      // console.log(objects_storage["upper" + result_index].shapes[0].height)
      objects_storage["drawn_upper_" + result_index].drawRect(
        0,
        0,
        objects_storage["upper" + result_index].shapes[0].width,
        objects_storage["upper" + result_index].shapes[0].height);
      objects_storage["container" + result_index].addChild(objects_storage["drawn_upper_" + result_index]);
    ...
    var end_animation_frame = 400; //150
    ...
    function animate(t){
      ...
      if (i < end_animation_frame) {
        ...
        objects_storage["drawn_floor_" + result_index].position.x = objects_storage["floor" + result_index].position[0];
        objects_storage["drawn_floor_" + result_index].position.y = objects_storage["floor" + result_index].position[1];
        objects_storage["drawn_ceiling_" + result_index].position.x = objects_storage["ceiling" + result_index].position[0];
        objects_storage["drawn_ceiling_" + result_index].position.y = objects_storage["ceiling" + result_index].position[1];

        objects_storage["drawn_block_A_" + result_index].position.x = objects_storage["block_ABody" + result_index].position[0] - objects_storage["block_ABody" + result_index].shapes[0].width/2;
        objects_storage["drawn_block_A_" + result_index].position.y = objects_storage["block_ABody" + result_index].position[1] - objects_storage["block_ABody" + result_index].shapes[0].height/2;

        objects_storage["drawn_block_B_" + result_index].position.x = objects_storage["block_BBody" + result_index].position[0] - objects_storage["block_BBody" + result_index].shapes[0].width/2;
        objects_storage["drawn_block_B_" + result_index].position.y = objects_storage["block_BBody" + result_index].position[1] - objects_storage["block_BBody" + result_index].shapes[0].height/2;

        objects_storage["drawn_lower_" + result_index].position.x = objects_storage["lower" + result_index].position[0] - objects_storage["lower" + result_index].shapes[0].width/2;
        objects_storage["drawn_lower_" + result_index].position.y = objects_storage["lower" + result_index].position[1] - objects_storage["lower" + result_index].shapes[0].height/2;

        objects_storage["drawn_upper_" + result_index].position.x = objects_storage["upper" + result_index].position[0] - objects_storage["upper" + result_index].shapes[0].width/2;
        objects_storage["drawn_upper_" + result_index].position.y = objects_storage["upper" + result_index].position[1] - objects_storage["upper" + result_index].shapes[0].height/2;
        ...
        if (objects_storage["ballEBody" + result_index]) {
          // Transfer positions of the physics objects_storage to Pixi.js
          objects_storage["drawn_ball_E_" + result_index].position.x = objects_storage["ballEBody" + result_index].position[0];
          objects_storage["drawn_ball_E_" + result_index].position.y = objects_storage["ballEBody" + result_index].position[1];
        }
...
$("body").append(
  "<pre class='results_json' id='results_json'>" +
