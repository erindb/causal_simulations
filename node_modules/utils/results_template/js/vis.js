...
var setup_animation_for_world = function(result_index) {
  ...
  objects_storage["capturer" + result_index] = new CCapture( {
    format: 'webm',
    framerate: 60
  } );
  ...
  function animate(t){
    ...
    if (i < 60) {
      ...
      objects_storage["capturer" + result_index].stop();
      $("#results" + result_index).append(
        "<button id='download" + result_index + "'>Download</button>"
      );
      $("#download" + result_index).click(function() {
        objects_storage["capturer" + result_index].save();
      });
    }
    ...
    if (i == 10) {
      objects_storage["capturer" + result_index].start();
    }
    if (i >= 10 & i < 60) {
      objects_storage["capturer" + result_index].capture( objects_storage["renderer" + result_index].view );
    }
  }
